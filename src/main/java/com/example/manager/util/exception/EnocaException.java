...
public class EnocaException extends RuntimeException implements Serializable {
    ...
    public EnocaException(ErrorCode errorCode, Throwable cause) {
    ...
    public EnocaException(ErrorCode errorCode) {
    ...
    public EnocaException(ErrorCode errorCode, String[] args) {
        super(errorCode.getName());
        this.errorCode = errorCode;
        this.errorMessage = errorCode.getName();
        this.args = args;
    ...
    public EnocaException(ErrorCode errorCode, String errorDetail) {
        super(errorCode.getName());
        this.errorCode = errorCode;
        this.errorMessage = errorCode.getName();
